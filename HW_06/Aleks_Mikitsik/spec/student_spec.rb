...
RSpec.describe 'Student #takes_hw and #complete_hw methods' do
  ...
  let(:homework) do
    double(hw_number: 'hw_01', hw_tasks:
    { task_1_1: 'some task_1_1 content', task_1_2: 'some task_1_2 content',
      task_1_3: 'some task_1_3 content', task_1_4: 'some task_1_4 content' })
  end

  let(:solutions_params) do
    { solved_tasks:
